    ...
    <div className="min-h-screen bg-[#0f172a]">
      <div className="mx-auto max-w-5xl px-4 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-4 mt-6">
          <div className="rounded-lg bg-[#1e293b] border border-[#334155] p-4 md:p-6">
            <div className="flex items-start gap-3">
              <div className="h-10 w-10 min-w-[2.5rem] rounded-full bg-[#3b82f6]/20 flex items-center justify-center">
